// Package events defines the event types shared between the agent and runner packages.
//
// These types were extracted from the runner package to break a circular
// dependency: the agent package needs Event types to implement Agent, and
// the runner package needs the Agent interface. Both import events.
package events

import "encoding/json"

// EventType enumerates the agent JSON protocol event types.
