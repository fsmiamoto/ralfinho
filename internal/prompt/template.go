...
7. If ALL tasks in the plan are now complete, output exactly: <promise>COMPLETE</promise>
...
6. If there is nothing left to do, output exactly: <promise>COMPLETE</promise>
7. Otherwise just finish normally — the loop will start a new iteration.`
